...
/*    Kg_sKernel.m_psRAMFSDevice = ( K_sKBlockIODevice_t * ) MemoryManager_KAlloc( sizeof( K_sKBlockIODevice_t ) );
    Kg_sKernel.m_psRAMFSDevice->m_pHandler = Floppy_Handler;
...
/*    Kg_sKernel.m_psRunningThread = ProcessManager_CreateProcess( "Kernel", Kg_sKernel.m_psRunningProcess );
    ...
    Console_Print( K_CIO_DEBUG, "FLOPPY", "Floppy device initialised\n" );
