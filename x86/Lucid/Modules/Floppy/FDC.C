...
void init(void)
{
   ...
   tbaddr = alloc_dma_buffer(512);

   /* install IRQ6 handler */
   set_irq_handler(6,irq6,&oldirq6);
   printf("IRQ6 handler installed\n");

   set_irq_handler(0x1c,int1c,&oldint1c);
   ...
   if (i == 0x80)
     ...
     printf("enhanced controller found\n");
}
...
void deinit(void)
{
   ...
   printf("uninstalling IRQ6 handler\n");
   set_irq_handler(0x1c,NULL,&oldint1c);
   printf("uninstalling timer handler\n");
