...
class Greedy {
    ...
    private static double distanceBetweenPointsLatLong(final double lat1, final double lon1, final double lat2, final double lon2) {
 ...
 //       List<String> teams = java.nio.file.Files.lines(Paths.get("/Users/daryl/Development/Projects/FunctionalComparison/Data/","DataSPIF.csv")).collect(Collectors.toList());  
        List<String> teams = java.nio.file.Files.lines(Paths.get("C:\\Data\\Development\\FunctionalComparison\\Data","DataSPIF.csv")).collect(Collectors.toList());  
